...
export async function GET() {
  return NextResponse.json([
    ...
    { id: 2, key: "category_2", icon: "/banners/thoitrangnam.jpg" },
    { id: 3, key: "category_3", icon: "/banners/thoitrangnu.jpg" },
    { id: 4, key: "category_4", icon: "/banners/giaydep.jpg" },
    { id: 5, key: "category_5", icon: "/banners/nuochoa.jpg" },
    ...
    { id: 11, key: "category_11", icon: "/banners/thethao.jpg" },
    ...
    { id: 16, key: "category_16", icon: "/banners/dongho.jpg" },
    { id: 18, key: "category_18", icon: "/banners/mayanh.jpg" },
    { id: 19, key: "category_19", icon: "/banners/dochoi.jpg" },
